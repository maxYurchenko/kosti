...
!(function (f, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["chart.js"], e)
    : ((f = f || self).ChartColorSchemes = e(f.Chart));
})(this, function (f) {
  "use strict";
  ...
  var e = Object.freeze({
    ...
    c = f.helpers,
    a = 2 === f.DatasetController.prototype.removeHoverStyle.length,
    b = "$colorschemes";
  f.defaults.global.plugins.colorschemes = {
  ...
  var r = {
    ...
    beforeUpdate: function (e, d) {
      var a,
        ...
        t = (function (e) {
          ...
          return c.isArray(e)
            ...
            : "string" == typeof e &&
              ((d = f.colorschemes || {}),
              (a = e.match(/^(brewer\.\w+)([1-3])-(\d+)$/))
                ? (e = a[1] + ["One", "Two", "Three"][a[2] - 1] + a[3])
                : "office.Office2007-2010-6" === e &&
                  (e = "office.OfficeClassic6"),
              (r = d[(b = e.split("."))[0]]))
            ? r[b[1]]
            : void 0;
        })(d.scheme),
      ...
      t &&
        ("function" == typeof B &&
          ((r = B((a = t.slice()))),
          c.isArray(r) && r.length
            ? (t = r)
            : c.isArray(a) && a.length && (t = a)),
        (l = t.length),
        e.config.data.datasets.forEach(function (f, d) {
          switch (
            ((o = d % l),
            (n = t[i ? l - o - 1 : o]),
            (f[b] = {}),
            f.type || e.config.type)
          ) {
            case "line":
            case "radar":
            case "scatter":
              (void 0 === f.backgroundColor || s) &&
                ((f[b].backgroundColor = f.backgroundColor),
                (f.backgroundColor = c.color(n).alpha(u).rgbString())),
                (void 0 === f.borderColor || s) &&
                  ((f[b].borderColor = f.borderColor), (f.borderColor = n)),
                (void 0 === f.pointBackgroundColor || s) &&
                  ((f[b].pointBackgroundColor = f.pointBackgroundColor),
                  (f.pointBackgroundColor = c.color(n).alpha(u).rgbString())),
                (void 0 === f.pointBorderColor || s) &&
                  ((f[b].pointBorderColor = f.pointBorderColor),
                  (f.pointBorderColor = n));
              break;
            case "doughnut":
            case "pie":
            case "polarArea":
              (void 0 === f.backgroundColor || s) &&
                ((f[b].backgroundColor = f.backgroundColor),
                (f.backgroundColor = f.data.map(function (f, e) {
    ...
    afterUpdate: function (f) {
      f.config.data.datasets.forEach(function (f) {
        f[b] &&
          (f[b].hasOwnProperty("backgroundColor") &&
            (f.backgroundColor = f[b].backgroundColor),
          f[b].hasOwnProperty("borderColor") &&
            (f.borderColor = f[b].borderColor),
          f[b].hasOwnProperty("pointBackgroundColor") &&
            (f.pointBackgroundColor = f[b].pointBackgroundColor),
          f[b].hasOwnProperty("pointBorderColor") &&
            (f.pointBorderColor = f[b].pointBorderColor),
          delete f[b]);
      });
    },
    beforeEvent: function (f, e, d) {
      a && this.beforeUpdate(f, d);
    },
    afterEvent: function (f) {
      a && this.afterUpdate(f);
    }
  };
